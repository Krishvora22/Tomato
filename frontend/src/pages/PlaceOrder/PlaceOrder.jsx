...
const PlaceOrder = () => {
  ...
  //   // }
  //   // else {
  //   //   alert("Devloper did not configured its strip account yet, because they dont give me permission for that and other service are costly so i cant do it now");
  //   // }
  // }
